...
public class TestImportByCsvFixSec {
	...
	public static void readeCsv() {
		try {
			...
			reader.close();
			AppAccount account = AppAccount.loginByAccessToken("http://oa.bgctv.com.cn","Y6Y5B9q3WRQu56NXckC0sOUiLYrk4Kf7FN2GLo5csfueYorz");
//			AppAccount account = AppAccount.loginByAccessToken("http://211.99.134.13/","etD8HwwL2xqEYQOeWK6h6o_xhYEmOORVm9d_-oUOCFNUsnq_");
			int count=1;
