...
<body>
<h2>直接联系某人，进行即时通讯的方式</h2>
<div>
<p>
<span style="color:red"><span id="user"></span><span id="data-mxim"><span data-mxim=""></span></span>  说成功了！
</p>
<p>
...
$("#user").text(user);
$("#data-mxim").html("<span data-mxim='" + user + "'></span>");
MX.onGraphLoad({
		    objectProperties: {
		        url: thirdurl+"?type=im",
		        type: "file",
		        title: "敏行培训对象im",
		        image: imageurl
		    },
